import {AdminBackendComponent} from './backend.component';
...
export const ADMIN_PAGES_BACKEND_DECLARATIONS = [
  ...
  AdminBackendIconsComponent,
  AdminBackendStatisticsComponent,
  AdminBackendResumeListTwbComponent,
  AdminBackendResumeListTysComponent,
  AdminBackendResumeItemTwbComponent,
  AdminBackendResumeItemTysComponent,
  AdminBackendResumeCheckComponent,
  AdminBackendResumeTurnComponent,

  AdminBackendTraineeListComponent,
  AdminBackendTraineeItemComponent,
  AdminBackendTraineeScoreComponent,
  AdminBackendTraineeVerifyListComponent,
  AdminBackendTraineeVerifyItemComponent,
  AdminBackendTraineeVerifyTurnComponent,
