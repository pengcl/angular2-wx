...
export const GUIDE_PAGES_DECLARATIONS = [
  GuideComponent,
  GuideStartComponent,
  GuidePosterComponent,
  GuideKnowledgeComponent,
  /*GuideStep1Component,
  GuideStep2Component,
  GuideStep3Component,
  GuideStep4Component,
  ...
  GuideWNStep4Component,
  GuideWNStep5Component,
  GuideWNStep6Component,
  GuideWNStep7Component,
  GuideWNStep8Component,
  GuideWNStep9Component
];
